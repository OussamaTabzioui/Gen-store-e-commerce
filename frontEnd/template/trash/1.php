<div class="page-banner-content text-center" style="display: block;">

    <div class="col-lg-6">
        <div class="basic-login mb-50">
            <button class="btn btn-success btn-rounded" style="padding: 10px 20px;">Let's Begin</button>
        </div>
    </div>
