...
// Ensure seller_name is treated as a string
$seller_name = isset($_GET['seller_name']) ? htmlspecialchars($_GET['seller_name']) : '';
?>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-banner-content text-center">
                            <h4 class="breadcrumb-title">Seller products</h4>
            ...
            <div class="d-flex justify-content-center align-items-center flex-column " style="width: 100%;">
                <section class="recomand-product-area  pt-50 pb-15" style="width: 100%;">
                    <div class="container custom-conatiner" style="width: 90%;">
                            ...
                            <div class="col-xl-12">
                                <div class="section__head d-flex justify-content-between mb-30">
                                    <div class="section__title section__title-2">
                                        <h5 class="st-titile">SELLER STACK</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-0">
                            <?php if ($seller_name && !empty(get_seller_products($seller_name))): ?>
                                <?php foreach (get_seller_products($seller_name) as $product): ?>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <p>No products found for the seller "<?= htmlspecialchars($seller_name) ?>".</p>
                            <?php endif; ?>
                        </div>
